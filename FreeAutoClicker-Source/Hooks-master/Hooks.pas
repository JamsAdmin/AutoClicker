...
function MouseIsDown(vkey:integer): Boolean;
begin
//VK_MBUTTON
//VK_LBUTTON
//VK_RBUTTON
...
begin
  ...
  begin
     //FKeyNames.KeyExtName :=Format('if str_vkCode=%s then vkCode=%d else',[VKeyName,FHookStruct.vkCode]);
     FKeyNames.KeyExtName := VKeyName +inttostr(FHookStruct.vkCode)
  end
  else
